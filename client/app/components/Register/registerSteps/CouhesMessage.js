...
const CouhesMessage = props => (
  <div>
    <div className="couhes-text">
      ...
      <p>If you have any questions or concerns about the research, please feel free to contact Ethan Zuckerman at (617) 324-4316 or ethanz@media.mit.edu.</p>
    ...
    <button className="button button_wide" onClick={props.onFinish}>I Agree</button>
  </div>
);

CouhesMessage.propTypes = propTypes;
