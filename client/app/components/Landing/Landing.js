			...
			<div id={'landing-page'}>
				<div className="content">
					...
					<div>
						...
						democratic society. We built Gobo to help demonstrate, and think about, how to do that.

						<h2>Our Solution</h2>
						<h3>Use Gobo to control the algorithms that govern what you see and what you don't on your
							social media feeds</h3>

						Sign up for Gobo, link it to your other social media profiles, and you can take control of your
						...
						Gobo is an experiment, not a startup. We are building it to change the conversation about social
						media, algorithms, and feeds. This is a technology-to-think-with; a tool that you should play
						with and challenge yourself to use. Gobo is being built by a small team of developers at the <a
						href="https://www.media.mit.edu/groups/civic-media/overview/">MIT Media Lab's Center for Civic
