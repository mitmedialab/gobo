...
class MuteAllMenWhy extends Component {
    ...
    render () {
        return (
            <span>
                <a onClick={this.openWhyModal}>{"  Why?"}</a>
                ...
                >
                    <div>
                        ...
                        <p>
                            {"Many have worried (and shown) " +
                            "that, like in the real world, men's voices tend to be over-represented on social media. " +
                        ...
                        <p>
                            {"You're probably wondering why there is no \"mute women\" button? " +
                            "On many of our feeds that is sadly the default already."}
                        </p>
                    </div>
